...
pragma solidity ^0.8.0; // ^0.4.18;

/**
 * @title IPFSStorage
 * @author originally written by Forest Fang (@saurfang) - modified by Chris Ball
 * original project: https://github.com/saurfang/ipfs-multihash-on-solidity
 * @dev Stores IPFS (multihash) hash by index (for NFTs)
...
contract IPFSStorage {
  ...
  mapping (uint => Multihash) private entries;  /** @dev nftIndex => IPFS address hash */
